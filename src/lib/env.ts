...
const schema = z.object({
  ...
  EID_PROVIDER: z.enum(["mock", "kobil", "ausweisident"]).default("mock"),
  EID_PROVIDER_BASE_URL: z.string().url().optional(),
  EID_PROVIDER_CLIENT_ID: z.string().min(1).optional(),
  EID_PROVIDER_CLIENT_SECRET: z.string().min(1).optional(),
